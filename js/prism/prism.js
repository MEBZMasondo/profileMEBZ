/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism-funky&languages=markup+css+clike+javascript+arduino+armasm+asciidoc+awk+bash+basic+batch+c+csharp+cpp+cobol+dart+docker+git+go+gradle+http+hpkp+hsts+java+javadoclike+json+json5+julia+kotlin+latex+lisp+markdown+markup-templating+mongodb+nasm+nginx+objectivec+perl+php+phpdoc+plsql+powershell+python+r+jsx+tsx+regex+sql+swift+typescript+vbnet+vim+yaml */
